    ...
    <div class="customer-order-detail">
                        ...
                        @if ($product)
                            <tr>
                                ...
                                <td class="text-center">
                                    <img src="{{ RvMedia::getImageUrl($product->image, 'thumb', false, RvMedia::getDefaultImage()) }}" width="50" alt="{{ $product->original_product->name }}"></td>
                                <td>
                                    {{ $product->original_product->name }}({{ $product->sku }})
        ...
        @if ($order->shipment->id)
            ...
            <p>
                ...
                <strong class="d-inline-block text-info">{!! clean($order->shipment->status->toHtml()) !!}</strong>
            </p>
