                                            ...
                                            @foreach ($order->products as $orderProduct)
                                                ...
                                                @endphp
                                                    ...
                                                    <td class="pl5 p-r5 min-width-200-px">
                                                        <a class="text-underline hover-underline pre-line" target="_blank" href="{{ $product ? route('products.edit', $product->original_product->id) : '#' }}" title="{{ $product ? $product->original_product->name : $orderProduct->product_name }}">
