                        ...
                        <div class="shipment-actions d-inline-block">
                            <div class="dropdown btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    @foreach(\Botble\Ecommerce\Enums\ShippingStatusEnum::values() as $key => $label)
                                        <li><a data-value="{{ $key }}" data-target="{{ route('ecommerce.shipments.update-status', $shipment->id) }}">{{ $label->label() }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                            @if ((float)$shipment->cod_amount)
                                <div class="dropdown btn-group p-l10">
                                    ...
                                    <ul class="dropdown-menu">
                                        @foreach(\Botble\Ecommerce\Enums\ShippingCodStatusEnum::values() as $key => $label)
                                            <li><a data-value="{{ $key }}" data-target="{{ route('ecommerce.shipments.update-cod-status', $shipment->id) }}">{{ $label->label() }}</a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            @endif
                    ...
                    <div class="pd-all-20 p-t15 p-b15 border-top-title-main ps-relative">
                        ...
                        @if ((float)$shipment->cod_amount)
                            ...
                            <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
                                ...
                                <div class="flexbox-grid-form-item text-end">
                                    {!! clean($shipment->cod_status->toHtml()) !!}
                                </div>
                            </div>
                        @endif
                        <div class="flexbox-grid-form flexbox-grid-form-no-outside-padding mb10">
