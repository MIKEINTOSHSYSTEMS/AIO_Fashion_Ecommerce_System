                ...
                <div class="col-md-12 col-sm-12">
                    <div
                        ...
                        <div class="panel-body">
                            ...
                            <p class="address"><i class="fa fa-map-marker" aria-hidden="true"></i> {{ $address->address }}, {{ $address->city_name }}
                                , {{ $address->state_name }}@if (EcommerceHelper::isUsingInMultipleCountries()), {{ $address->country_name }} @endif @if (EcommerceHelper::isZipCodeEnabled()), {{ $address->zip_code }} @endif</p>
        ...
        <div class="modal-dialog modal-xs">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button class="btn--custom btn--rounded btn--outline btn--sm" type="button" data-dismiss="modal">{{ __('Cancel') }}</button>
