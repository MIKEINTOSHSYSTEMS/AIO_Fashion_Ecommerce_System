                 ...
                 <div class="form__content">
                     ...
                     <div class="form-group">
                         ...
                         <div class="form__password">
                             <input class="form-control" type="password" name="password" id="txt-password" autocomplete="password" placeholder="{{ __('Please enter your password') }}"><a href="{{ route('customer.password.reset') }}">{{ __('Forgot password?') }}</a>
                         </div>
