                    ...
                    <div class="slider__content">
                        <div class="slider__content__wrapper">
                            <div class="slider__content__wrapper__content">
                                ...
                                @endif
                                @if ($slider->link)
                                    <a class="btn--custom btn--rounded staggered-animation animated fadeInUp" href="{{ $slider->link }}" data-animation="fadeInUp" data-animation-delay="0.5s">{!! clean($buttonText ?: __('Shop Now')) !!}</a>
                                @endif
                            </div>
                        </div>
                    </div>
